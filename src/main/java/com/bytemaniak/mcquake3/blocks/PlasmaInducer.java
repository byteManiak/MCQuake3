...
public class PlasmaInducer extends AbstractFurnaceBlock {
	...
	@Override
	protected MapCodec<? extends AbstractFurnaceBlock> getCodec() { return null; }
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return world.isClient ? null: PlasmaInducer.validateTicker(type, Blocks.PLASMA_INDUCER_BLOCK_ENTITY, PlasmaInducerEntity::tick);
	}
