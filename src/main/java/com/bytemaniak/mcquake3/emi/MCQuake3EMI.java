...
public class MCQuake3EMI implements EmiPlugin {
    ...
    public void register(EmiRegistry registry) {
        ...
        for (RecipeEntry<PlasmaInducerRecipe> recipe : manager.listAllOfType(PlasmaInducerRecipe.PlasmaInducerType.INSTANCE))
            registry.addRecipe(new EMIPlasmaInducerRecipe(recipe.value()));
    }
}
