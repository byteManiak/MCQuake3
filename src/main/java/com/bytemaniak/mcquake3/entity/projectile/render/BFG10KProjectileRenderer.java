...
public class BFG10KProjectileRenderer extends EntityRenderer<BFG10KProjectile> {
    private static final Identifier TEXTURE = Identifier.of("mcquake3:textures/entity/bfg10k_projectile.png");
    ...
    @Override
    public Identifier getTexture(BFG10KProjectile entity) {
        return TEXTURE;
    }

    @Override
    public void render(BFG10KProjectile entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
