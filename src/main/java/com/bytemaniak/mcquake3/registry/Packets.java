...
public class Packets {
    ...
    public static final Identifier WEAPON_COOLDOWNS_UPDATE = new Identifier("mcquake3:weapon_cooldowns_update");
    ...
    public static void registerServerPackets()
    {
        ...
        ServerPlayNetworking.registerGlobalReceiver(WEAPON_COOLDOWNS_UPDATE, WeaponCooldownsUpdateC2SPacket::receive);
