...
public class Q3StatusEffects {
    ...
    public static StatusEffectInstance fromEffect(RegistryEntry<StatusEffect> effect, int amplifier) {
        return new StatusEffectInstance(effect, MiscUtils.toTicks(30), amplifier);
    }

    public static StatusEffectInstance fromEffect(RegistryEntry<StatusEffect> effect) {
        return new StatusEffectInstance(effect, MiscUtils.toTicks(30), 0);
    }

    public static void registerEffects() {
        Registry.register(Registries.STATUS_EFFECT, Identifier.of("mcquake3:quad_damage"), QUAD_DAMAGE);
    }
}
